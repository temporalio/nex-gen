...
import (
	...
	apishowcase "examples/go/json_schema/api/showcase"
...
func TestJSONSchemaShowcaseRuntime(t *testing.T) {
	...
	minimal := roundTripJSONEq[apishowcase.Showcase](t, dc, "showcase", "showcase-minimal.json")
	require.Equal(t, apishowcase.ShowcaseKindShowcase, minimal.Kind)
	...
	nulls := decodeFixture[apishowcase.Showcase](t, dc, "showcase", "showcase-nulls.json")
	require.Nil(t, nulls.MiddleName)
	require.Nil(t, nulls.Category)
	require.False(t, nulls.Active)

	address := roundTripJSONEq[apishowcase.Address](t, dc, "showcase", "address-open.json")
	require.Equal(t, "1 Main St", address.Street)
	require.Contains(t, address.AdditionalProperties, "x-extra")

	labels := roundTripJSONEq[apishowcase.Labels](t, dc, "showcase", "labels.json")
	require.Equal(t, "prod", labels.AdditionalProperties["env"])
	require.Equal(t, "core", labels.AdditionalProperties["team"])

	settings := roundTripJSONEq[apishowcase.Settings](t, dc, "showcase", "settings.json")
...
func TestJSONSchemaShowcaseNumericConstraints(t *testing.T) {
	...
	metrics := roundTripJSONEq[apishowcase.Showcase](t, dc, "showcase", "showcase-metrics.json")
...
func TestJSONSchemaShowcaseStringLength(t *testing.T) {
	...
	strings := roundTripJSONEq[apishowcase.Showcase](t, dc, "showcase", "showcase-strings.json")
...
func TestJSONSchemaShowcasePattern(t *testing.T) {
	...
	patterns := roundTripJSONEq[apishowcase.Showcase](t, dc, "showcase", "showcase-patterns.json")
...
func TestJSONSchemaShowcaseFormat(t *testing.T) {
	...
	formats := roundTripJSONEq[apishowcase.Showcase](t, dc, "showcase", "showcase-format.json")
...
func TestJSONSchemaShowcaseContentEncoding(t *testing.T) {
	...
	bytesCase := roundTripJSONEq[apishowcase.Showcase](t, dc, "showcase", "showcase-bytes.json")
...
func TestJSONSchemaShowcaseArrayConstraints(t *testing.T) {
	...
	valid := decodeFixture[apishowcase.Showcase](t, dc, "showcase", "showcase-full.json")
	bad := valid
...
func TestJSONSchemaShowcaseObjectConstraints(t *testing.T) {
	...
	attributes := roundTripJSONEq[apishowcase.Attributes](t, dc, "showcase", "attributes.json")
	...
	var attrs apishowcase.Attributes
...
func TestJSONSchemaShowcaseAllOfMerge(t *testing.T) {
	...
	widget := roundTripJSONEq[apishowcase.Widget](t, dc, "showcase", "widget.json")
...
func TestJSONSchemaShowcaseClosedValues(t *testing.T) {
	...
	bad := full
	bad.Status = apishowcase.ShowcaseStatus("archived")
	_, serr := dc.ToPayload(bad)
	require.Error(t, serr)
...
func TestJSONSchemaShowcaseUnions(t *testing.T) {
	...
	s := roundTripJSONEq[apishowcase.Showcase](t, dc, "showcase", "showcase-union-string.json")
	require.Equal(t, apishowcase.ShowcaseIdOrNameString("abc"), s.IdOrName)

	// Disjoint-kind union: integer branch.
	i := roundTripJSONEq[apishowcase.Showcase](t, dc, "showcase", "showcase-union-int.json")
	require.Equal(t, apishowcase.ShowcaseIdOrNameInteger(7), i.IdOrName)

	// Discriminated union: circle branch.
	circle := roundTripJSONEq[apishowcase.Showcase](t, dc, "showcase", "showcase-shape-circle.json")
	c, ok := circle.Shape.(apishowcase.Circle)
	require.True(t, ok, "shape should be a Circle")
	require.Equal(t, apishowcase.CircleKindCircle, c.Kind)
	require.Equal(t, 2.5, c.Radius)

	// Discriminated union: square branch.
	square := roundTripJSONEq[apishowcase.Showcase](t, dc, "showcase", "showcase-shape-square.json")
	sq, ok := square.Shape.(apishowcase.Square)
	require.True(t, ok, "shape should be a Square")
	require.Equal(t, apishowcase.SquareKindSquare, sq.Kind)

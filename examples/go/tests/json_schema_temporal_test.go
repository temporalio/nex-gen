...
import (
	...
	apitemporal "examples/go/json_schema/api/temporal"
...
func TestJSONSchemaTemporalRuntime(t *testing.T) {
	...
	full := roundTripJSONEq[apitemporal.Temporal](t, dc, "temporal", "temporal-full.json")
	...
	roundTripJSONEq[apitemporal.Temporal](t, dc, "temporal", "temporal-minimal.json")
}
...
func TestJSONSchemaTemporalCanonicalization(t *testing.T) {
	dc := converter.GetDefaultDataConverter()
	canon := decodeFixture[apitemporal.Temporal](t, dc, "temporal", "temporal-canonicalize.json")
...
func TestJSONSchemaTemporalNulls(t *testing.T) {
	dc := converter.GetDefaultDataConverter()
	nulls := decodeFixture[apitemporal.Temporal](t, dc, "temporal", "temporal-nulls.json")

...
- [x] Replace remaining hardcoded `NexusApiGen.Support.TemporalModelConverters` references with the well-known `NexusApiGen.Support.ProtoConverters` support path.

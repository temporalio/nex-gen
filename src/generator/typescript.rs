...
use crate::generator::proto::typescript::{
    ...
    record_proto_info, typescript_default_from_proto_name, typescript_default_to_proto_name,
...
use crate::spec::{
    ...
    IntSpec, LanguageImportSpec, LanguageImportStyle, LanguageStringSpec, OperationSpec,
...
fn resolve_operation<'a>(
    ...
    Ok(RenderedOperation {
        ...
        input_nexus_type_id: if matches!(input, PlannedType::Record(_))
            && record_proto_info(input, api_plan).is_none()
        {
...
fn build_field(
    ...
    let proto_field_name = typescript_generated_field_name(field_name);
    let doc = field
        .doc
        .as_ref()
...
fn build_sourced_field(
    ...
    if let PlannedType::Map(_, value) = &field.field_type {
        ...
        return RenderedSourcedField {
            ...
            to_proto_expr: map_value_to_proto_expr_from_expr(&value_type, source_expr),
        };
    }
...
fn required_from_proto_expr(
    ...
    let proto_value_expr = if field_has_presence(field) {

...
impl<'a> ApiPlanner<'a> {
    fn new(api_plan: &'a PlannedSpec) -> Result<Self> {
        Ok(Self {
            api_plan,
            external_models: TypeScriptExternalModels::new(api_plan)?,
            enums: IndexMap::new(),
            flags: IndexMap::new(),
    ...
    fn build_flattened_message_field(
        ...
        let full_name = field.field_type.model_full_name()?;
...
pub(crate) fn generate(
    ...
    let mut planner = ApiPlanner::new(api_plan)?;
...
fn render_module_files(
    ...
    files.insert(
        ...
        render_service_module(
            ...
            variants,
            models,
            &model_fragments.exported_names,
            services,
            requirements,
            language_imports,
...
fn render_service_module(
    ...
    include_operation_registry: bool,
) -> String {
    let mut body = String::new();
    for service in services {

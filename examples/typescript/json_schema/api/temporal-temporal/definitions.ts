...
export function parseTemporalDateTime(
...
): TemporalApi.ZonedDateTime | undefined {
  ...
  return TemporalApi.ZonedDateTime.from(`${canon}[${zone}]`);
}
...
export function parseTemporalDate(
  ...
  path: string,
  violations: Violation[],
): TemporalApi.PlainDate | undefined {
  ...
  return TemporalApi.PlainDate.from(value);
}
...
export function parseTemporalDuration(
  ...
  path: string,
  violations: Violation[],
): TemporalApi.Duration | undefined {
  ...
  return TemporalApi.Duration.from({ seconds });
}

...
fn python_proto_generics_propagate_payload_type_hints() {
    ...
    assert!(models.contains("_output_type, _context_type = typing.get_args(type_hint)"));
    assert!(models.contains(
    ...
    assert!(models.contains("_output_type, = typing.get_args(type_hint)"));
    assert!(models.contains("payload_from_proto(proto.details, _output_type)"));
    assert!(models.contains("_context_type, = typing.get_args(type_hint)"));
    assert!(models.contains("payload_from_proto(proto.details, _context_type)"));

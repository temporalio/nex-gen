...
fn build_field(
    ...
    if let Some(with_arguments) = &field.with_arguments {
        ...
        return RenderedField {
            ...
            to_proto_expr: match (field.required, function_converter) {
                (true, Some(converter)) => {
                ...
                (true, None) => required_with_arguments_to_proto_expr(
                    &resolved_type,
                    &owner_name,
                    &generated_field_name,
                    &with_arguments.name_expr,
                ),
                (false, None) => optional_with_arguments_to_proto_expr(
                    &resolved_type,
                    &generated_field_name,
                    &with_arguments.name_expr,
                ),
    ...
    match invocation {
        RenderedInvocationField::Function(function) => {
            let args_annotation = format!(
                ...
                function.type_parameter_name, function.type_parameter_name
            );
            render_request_invocation_union(
                ...
                &function.type_parameter_name,
                &format!("Parameters<{}>", function.type_parameter_name),
                &args_annotation,
            );
        }
...
fn render_request_invocation_union(
    ...
    args_field_name: &str,
    string_value_annotation: &str,
    string_args_annotation: &str,
